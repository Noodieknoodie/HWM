...
-- procedure: sp_refresh_quarterly_cache
-- procedure: sp_test_summary
-- function: calculate_expected_fee (SQL_SCALAR_FUNCTION)
-- function: get_variance_status (SQL_SCALAR_FUNCTION)
-- index: IX_client_quarter_markers_year_quarter
...
-- index: idx_payment_periods_dates
-- index: idx_payments_client_id
-- index: idx_payments_contract_id
-- index: idx_payments_date
-- index: idx_payments_period_lookup
-- index: IX_payments_summary_fast
-- index: IX_quarterly_notes_fast
-- trigger: tr_payments_refresh_cache
...
-- 37 | 30 | 'TEST-001-NEW' | 'TEST PROVIDER A' | 2021-07-01 | 'flat' | NULL | 1200.0 | 'monthly' | 50 | NULL | True
-- 39 | 31 | 'TEST-002-NEW' | 'TEST PROVIDER A' | 2021-07-01 | 'flat' | NULL | 3600.0 | 'quarterly' | 75 | NULL | True
-- 41 | 32 | 'TEST-003-NEW' | 'TEST PROVIDER A' | 2021-07-01 | 'percentage' | 0.0009 | NULL | 'monthly' | 100 | NULL | True
-- Table: payment_periods
...
-- 1161 | 37 | 30 | 2024-12-16 | 2785000.0 | 1200.0 | 'ACH' | NULL | 'monthly' | 12 | 2024
-- Table: quarterly_notes
...
-- 30 | 'TEST-MONTHLY-FLAT' | 'TEST MONTHLY FLAT FEE CLIENT CORPORATION' | 37 | 'TEST PROVIDER A' | 'monthly' | 'flat' | NULL | 1200.0 | 2021-07-01 | 2021 | 7 | 'monthly' | 3 | 'July 2021' | 2025 | 6 | 2025 | 2
-- 30 | 'TEST-MONTHLY-FLAT' | 'TEST MONTHLY FLAT FEE CLIENT CORPORATION' | 37 | 'TEST PROVIDER A' | 'monthly' | 'flat' | NULL | 1200.0 | 2021-07-01 | 2021 | 8 | 'monthly' | 3 | 'August 2021' | 2025 | 6 | 2025 | 2
-- 30 | 'TEST-MONTHLY-FLAT' | 'TEST MONTHLY FLAT FEE CLIENT CORPORATION' | 37 | 'TEST PROVIDER A' | 'monthly' | 'flat' | NULL | 1200.0 | 2021-07-01 | 2021 | 9 | 'monthly' | 3 | 'September 2021' | 2025 | 6 | 2025 | 2
-- View: clients
...
-- 1161 | 37 | 30 | 2024-12-16 | 2785000.0 | 1200.0 | 1200.0 | 'ACH' | NULL | 'monthly' | 12 | 2024 | 'TEST PROVIDER A' | 'Dec 2024' | 2785000.0 | 0 | 0.0 | 0.0 | 'exact'
-- View: payment_status_base
...
-- Sample data (3 rows):
-- provider_name | provider_client_count | provider_actual_total | provider_expected_total | provider_variance | clients_posted | total_clients | provider_posted_display | client_id | display_name | payment_schedule | fee_type | percent_rate | flat_rate | quarterly_rate | client_expected | client_actual | client_variance | client_variance_percent | variance_status | payment_count | expected_payment_count | payment_status_display | fully_posted | has_notes | quarterly_notes | posted_count | is_posted | applied_year | quarter | row_type
-- 'Ascensus' | 2 | 6592.63 | 2000.0 | 4592.63 | 0 | 2 | '0/2' | 8 | 'Dakota Creek' | 'quarterly' | 'percentage' | 0.003446 | NULL | 0.3446 | 0.0 | 4592.63 | 4592.63 | NULL | 'unknown' | 1 | 1 | '1/1' | 0 | 0 | NULL | 0 | False | 2024 | 4 | 'client'
-- 'Ascensus' | 2 | 6592.63 | 2000.0 | 4592.63 | 0 | 2 | '0/2' | 19 | 'Opportunity Interactive' | 'quarterly' | 'flat' | NULL | 2000.0 | 2000.0 | 2000.0 | 2000.0 | 0.0 | 0.0 | 'exact' | 1 | 1 | '1/1' | 0 | 0 | NULL | 0 | False | 2024 | 4 | 'client'
-- 'Ascensus' | 2 | 7194.0 | 2000.0 | 5194.0 | 0 | 2 | '0/2' | 19 | 'Opportunity Interactive' | 'quarterly' | 'flat' | NULL | 2000.0 | 2000.0 | 2000.0 | 2000.0 | 0.0 | 0.0 | 'exact' | 1 | 1 | '1/1' | 0 | 0 | NULL | 0 | False | 2025 | 1 | 'client'
-- View: quarterly_summary_aggregated
